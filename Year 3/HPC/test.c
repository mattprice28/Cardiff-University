...
int main (int argc, const char * argv[]) {
    // insert code here...
	static int const maxlen = 200, rowsize = 521, colsize = 428, linelen = 12, threadcount = 8, chunkSize = 1000;
	...
	for(k=0;k<nblurs;k++){
		#pragma omp parallel shared(nblurs,Rnew,Gnew,Bnew,R,G,B) private(k,row,col) num_threads(threadcount)
		{

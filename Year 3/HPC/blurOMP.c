...
int main (int argc, const char * argv[]) {
	...
	struct timeval tim;
        R = (int **)malloc((sizeof(int*)*rowsize));
        G = (int **)malloc((sizeof(int*)*rowsize));
        B = (int **)malloc((sizeof(int*)*rowsize));
        Rnew = (int **)malloc((sizeof(int*)*rowsize));
        Gnew = (int **)malloc((sizeof(int*)*rowsize));
        Bnew = (int **)malloc((sizeof(int*)*rowsize));
        for (k=0;k<rowsize;k++){
            R[k] = (int *)malloc(sizeof(int)*colsize);
            G[k] = (int *)malloc(sizeof(int)*colsize);
            B[k] = (int *)malloc(sizeof(int)*colsize);
            Rnew[k] = (int *)malloc(sizeof(int)*colsize);
            Gnew[k] = (int *)malloc(sizeof(int)*colsize);
            Bnew[k] = (int *)malloc(sizeof(int)*colsize);
        }
	...
	for(k=0;k<nblurs;k++){
		#pragma omp parallel shared(nblurs,Rnew,Gnew,Bnew,R,G,B) private(k,row,col) num_threads(threads)
		{
